...
#create lucene index
java -cp ../target/semvec-lucene-tools-1.2-jar-with-dependencies.jar io.seldon.semvec.CreateLuceneIndexFromDb -l wiki_film_index -raw-ids -use-item-attrs -attr-names film_abstract -recreate -item-limit 90000 -jdbc "jdbc:mysql://localhost:3306/wiki_film?user=${MYSQL_USER}&characterEncoding=utf8"
